...
import 'package:WeightApp/sundayschool/sundayschoolDetails.dart';
...
class sundayschool extends StatefulWidget {
  @override
  sundayschoolState createState() => sundayschoolState();
}

class sundayschoolState extends State<sundayschool> {
  List<Color> myColors = [
    Colors.yellow[200],
    Colors.red[200],
    Colors.green[200],
                              ...
                              children: [
                                Card(
                                  child: ListTile(
                                    ...
                                    title: Text(
                                      "${data['sundayschooltitle']}",
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold),
                                    ),
                                    subtitle: Text(
                                        "${data['sundayschooldate']}"
                                            .replaceAll(
                                            '00:00:00.000', '')),
                                    trailing: Icon(Icons.navigate_next),
                                  ),
                                ...
                                //               Container(
                                //                 child: Text(
                                //                   "${data['sundayschooldate']}".replaceAll('00:00:00.000', ''),
                                //                   style: TextStyle(
                                //                     fontSize: 17.0,
                                //                     fontFamily: "lato",
                                //                     color: Colors.black87,
                      ...
                      if (!snapshot.hasData)
                        ...
                        return snapshot.data["lock"] == true
                          ...
                          MediaQuery.of(context).size.height *
                              .9,
                          child: payment(
                              month: 'JANUARY', type: 'sundayschool'),
                        );
                    },
                  );
                else
                  ...
                  builder: (context, snapshot) {
                    if (!snapshot.hasData)
                      ...
                      return snapshot.data["lock"] == true
                        ...
                        child: payment(
                            month: 'FEBRUARY', type: 'sundayschool'),
                      );
                  },
                );
              else
                  ...
                  builder: (context, snapshot) {
                    if (!snapshot.hasData)
                      ...
                      return snapshot.data["lock"] == true
                        ...
                        MediaQuery.of(context).size.height * .9,
                        child: payment(
                            month: 'AUGUST', type: 'sundayschool'),
                      );
                  },
                );
              else
                  ...
                  builder: (context, snapshot) {
                    if (!snapshot.hasData)
                      ...
                      return snapshot.data["lock"] == true
                        ...
                        MediaQuery.of(context).size.height * .9,
                        child: payment(
                            month: 'SEPTEMBER', type: 'sundayschool'),
                      );
                  },
                );
              else
                  ...
                  builder: (context, snapshot) {
                    if (!snapshot.hasData)
                      ...
                      return snapshot.data["lock"] == true
                        ...
                        MediaQuery.of(context).size.height * .9,
                        child: payment(
                            month: 'OCTOBER', type: 'sundayschool'),
                      );
                  },
                );
              else
                  ...
                  builder: (context, snapshot) {
                    if (!snapshot.hasData)
                      ...
                      return snapshot.data["lock"] == true
                        ...
                        MediaQuery.of(context).size.height * .9,
                        child: payment(
                            month: 'NOVEMBER', type: 'sundayschool'),
                      );
                  },
                );
              else
                  ...
                  builder: (context, snapshot) {
                    if (!snapshot.hasData)
                      ...
                      return snapshot.data["lock"] == true
                        ...
                        MediaQuery.of(context).size.height * .9,
                        child: payment(
                            month: 'DECEMBER', type: 'sundayschool'),
                      );
                  },
                );
              else
